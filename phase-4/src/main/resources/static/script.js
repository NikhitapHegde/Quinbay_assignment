const apiUrl = "http://localhost:8080/api/todos"; // Ensure this is correct
...
function markComplete(id) {
    ...
    .then(data => {
        ...
        todoItem.classList.add('completed'); // Add completed class for styling
...
function deleteTodo(id) {
    ...
    .then(response => {
        ...
        return response.json(); // Optional if your backend returns something useful
    })
    .then(() => {
        console.log(`Todo with id ${id} deleted`); // Debugging line
        todoItem.remove();
...
// Listen for Enter key press to add a todo
...
// Function to update task counts (completed and total)
